              ...
              <p class="sh1">Новый заказчик</p>
				  ...
				  <form action="" method="POST">
					<div class="row mt-3 mr-5 align-items-center" style="">
						...
						<input required class="col form-control" name="cust_name" type="text" placeholder="наименование заказчика" style="border: 1px solid <?if($err)echo "rgba(255,0,0,.40);"; else echo "rgba(0,0,0,.40);";?> background-color: rgba(255,255,255,.20); font-size: small;">
