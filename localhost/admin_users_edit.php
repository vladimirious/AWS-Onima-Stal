    ...
    <div class="row justify-content-md-center" style="width:1080px;">
      <div class="col-fluid" >
        <div class="side-bar" style="width: 100px; height:661px;">
          ...
          <div class="row-fluid">
            <div class="col text-center nopadding">
				<a href="admin_main"><img src="img/users_sb.png" class="img"></a>
            </div>
          </div>
          <div class="row-fluid">
            <div class="col text-center nopadding">
      ...
      <div class="col-fluid">
        <div class="main-w" style="width: 980px; height:661px;">
          ...
          <div class="row-fluid ml-3">
            <div class="col">
              <p class="sh1">Изменение учетных данных пользователей</p>
            </div>
          </div>
            ...
            <div class="col">
              <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar pr-3">
                  <table class="table table-hover table-striped table-sm" style="overflow: auto">
                    <thead>
                       <tr>
                         <th scope="col" class=""><small>ФИО</small></th>
						 <th scope="col" class=""><small>Таб.№</small></th>
                         <th scope="col" class=""><small>Должность</small></th>
                         <th scope="col" class=""><small>Подразделение</small></th>
                         <th scope="col" class=""><small>Логин</small></th>
...
FROM
    users
LEFT JOIN employees ON Users.TAB_N = employees.TAB_N
...
//	echo $rows;
		for ($i = 0 ; $i < $rows ; ++$i)
		{
			...
			echo "<td><small>".$row[0].' '.$row[1].' '.$row[2]."</small></td>";
				for ($j = 3 ; $j < 7 ; ++$j) echo "<td><small>".$row[$j]."</small></td>";
			echo "<td><a href='admin_user_edit?n=".$row[7]."'><small>Ред.</small></a></td>";
			echo "</tr>";
		}
