...
if(isset($_POST['submit'])){
	...
	{
		$QUERY = "INSERT INTO pr_contract_docs (TYPE, Link, Comments, Proj_id) VALUES ('smeta', '".$uploadfile."', '".$_POST['comment']."', ".$_GET["n"].")";
			...
			<div class="col-fluid">
				<div class="main-w" style="width: 980px; height:661px;">
					...
					<div class="row-fluid ml-3 ">
						<div class="col">
							<p class="sh1 mb-1">Новая смета</p>
						</div>
					</div>
<!--############################################################################# -->
						<form action="" method="POST" enctype="multipart/form-data">
							...
							<div class="row mt-3 mr-5 align-items-center" style="">
								...
								<div class="col-md-2 p-0" name="cust_id">
									<button class="btn btn-primary btn-sm btn-block m-0" type="submit" name="submit">Добавить</button>
								</div>
							</div>
						</form>
<!--############################################################################# -->
