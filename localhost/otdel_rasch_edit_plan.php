...
if(isset($_POST['submit'])){
	...
	if ($_FILES['userfile']['name']!=""){
		...
		$_FILES['userfile']['name'] = "plan_n".$_GET["n"].substr($my_string, $point_place, $type_len);
			...
			<div class="col-fluid">
				<div class="main-w" style="width: 980px; height:661px;">
					...
					<div class="row-fluid ml-3 ">
						<div class="col">
							<p class="sh1 mb-1">Редактирование плана</p>
						</div>
					</div>
<!--############################################################################# -->
						<form action="" method="POST" enctype="multipart/form-data">
							...
							<div class="row mt-3 mr-5 align-items-center" style="">
								...
								<input class="col form-control" name="comment" type="text" value="<?echo $plan[0];?>" placeholder="комментарий" style="border: 1px solid rgba(0,0,0,.40); background-color: rgba(255,255,255,.20); font-size: small;">
								<div class="col-md-3 ml-4"></div>
							</div>
