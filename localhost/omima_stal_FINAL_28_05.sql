...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 28 2019 г., 16:57
...
(2, 1483, 1, NULL, 'files/contracts/contract_n3.docx', 'Предварительный вариант договора.', 0, 0, 3, 3),
(3, 777, 1, '2019-05-17', 'files/contracts/contract_n4.docx', 'Лучший договор', 1, 1, 4, 4);
...
(4, 'ООО ЛАККИ ПРОДЖЕКТ', '+17777777777', 'Самый лучший заказчик', 'Пинки Пай', 'info@lp.pl', 125978638, 4569835424781, 77777777777, 658725798634, 'Пониленд, Понивиль, ул. Яблок, 7');
...
(2, 'Сварочный аппарат', 'Цех 2 - Площадка 2Б', '2018-07-09', '5 лет', 'H891988', 120000.00),
(3, 'Молоток', 'Цех 1 - Площадка 1A', '2019-05-26', 'Не ограничен', 'M123', 100.00);
...
--
-- Дамп данных таблицы `equip_for_proj`
--

INSERT INTO `equip_for_proj` (`Eq_proj_id`, `Comments`, `Proj_id`, `Equip_id`) VALUES
(1, NULL, 4, 1),
(3, '', 4, 2);
...
--
-- Дамп данных таблицы `konstr_doc`
--

INSERT INTO `konstr_doc` (`Konstr_doc_id`, `Link`, `Comments`, `Prov_id`, `Proj_id`) VALUES
(1, 'files/konstr_docs/konstr_doc_n1.pdf', 'В работу', 2, 4),
(2, 'files/konstr_docs/konstr_doc_n2.png', 'Завершен', 2, 4);
...
CREATE TABLE `mater_for_proj` (
  ...
  `Numb` tinytext NOT NULL,
  `Comments` text NOT NULL,
  `S_section` tinytext CHARACTER SET utf8 COLLATE utf8_general_ci,
...
--
-- Дамп данных таблицы `mater_for_proj`
--

INSERT INTO `mater_for_proj` (`Mat_proj_id`, `Numb`, `Comments`, `S_section`, `Arr_date`, `Del_date`, `Name`, `Proj_id`) VALUES
(1, '100 литров', 'Молоко не более 3.5%', '1Б', '2019-05-28', NULL, 'Молоко 100 литров', 4);
...
(4, 0, 'Сказочный проект', 0, 4, 4, 2, '2019-05-17', NULL);
...
(4, 4, '2019-05-17', '2019-05-18', 1, '2019-05-23', '2019-05-20', 1, '2019-05-27', '2019-05-21', 0, NULL, '2019-05-22', 0, NULL, '2019-05-28');
...
CREATE TABLE `providers` (
  `Prov_id` int(3) NOT NULL,
  `Prov_name` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Addr` text NOT NULL,
  `Prov_tel` varchar(25) NOT NULL,
  `Comments` text NOT NULL,
  `Cont_prov_name` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `E_mail` varchar(50) NOT NULL,
  `Kpp` bigint(50) NOT NULL,
  `OGRN` bigint(50) NOT NULL,
  `Check_acc` bigint(50) NOT NULL,
...
INSERT INTO `providers` (`Prov_id`, `Prov_name`, `Addr`, `Prov_tel`, `Comments`, `Cont_prov_name`, `E_mail`, `Kpp`, `OGRN`, `Check_acc`, `ITN`, `Work_id`) VALUES
(1, 'ООО Молочное царство', 'Пониленд, Понивиль, ул. Радужная, 1', '+17777777772', 'Молоко и сливки', 'Флаттершай', 'info@mk.pl', 658975429, 7854721356852, 10123456749, 658725794634, 5),
(2, 'ООО Бюро Конструкторов', 'Пониленд, Понивиль, ул. Ромашек, 5', '+17777733377', 'Самые лучшие чертежы', 'Мистер Покс', 'info@bk.pl', 895475698, 5483698575475, 698754589, 8567895423598, 6);
...
(2, 'plan', '2019-05-17', 'files/plans/plan_n4.jpg', 'Самый лучший план одобрен!', 4),
(3, 'smeta', '2019-05-25', 'files/smets/smeta_n4.png', 'Лучшая смета на свете одобрена!', 4);
...
INSERT INTO `specifications` (`Spec_id`, `Spec_date`, `Link`, `Comments`, `Proj_id`) VALUES
(1, '2019-05-25', 'files/specs/spec_n4.pdf', 'Согласованная в работу.', 4);
...
CREATE TABLE `supplies` (
  ...
  `Stat_1` tinyint(1) DEFAULT NULL,
  `Stat_2` tinyint(1) DEFAULT '0',
  `Stat_3` tinyint(1) NOT NULL DEFAULT '0',
  `Numb` tinytext NOT NULL,
  `Comments` text NOT NULL,
  `Link` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  `Stat_4` tinyint(1) NOT NULL,
  `Proj_id` int(3) NOT NULL,
  `Prov_id` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `supplies` (`Supp_id`, `Stat_1`, `Stat_2`, `Stat_3`, `Numb`, `Comments`, `Link`, `Stat_4`, `Proj_id`, `Prov_id`) VALUES
(1, 1, 1, 1, '100 литров', 'Молоко не более 3.5%', 'files\\purchase_docs\\purchase_n1.png', 0, 4, 1),
(2, 1, 1, 1, 'Развернутые чертежы вагона', 'Одобрено', 'files/purchase_docs/purchase_n2.vpp', 1, 4, 2),
(3, 1, 1, 1, 'Чертежи охлаждающих элементов', 'Одобрено', 'files/purchase_docs/purchase_n3.png', 1, 4, 2),
(4, NULL, 0, 0, 'Чертеж колеса', 'На согласование', 'files/purchase_docs/purchase_n4.jpg', 1, 4, 2);
...
--
-- Дамп данных таблицы `techn_doc`
--

INSERT INTO `techn_doc` (`Techn_doc_id`, `Link`, `Comments`, `Proj_id`) VALUES
(1, 'files/techn_docs/techn_doc_n1.jpg', 'Первый цех.', 4),
(2, 'files/techn_docs/techn_doc_n2.jpg', 'Второй цех.', 4);
...
(4, 'files/techichic_docs/tech_doc_n4.doc', 'Секретный рецепт', 'Рецепт мороженного', 4);
...
(1, 'admin1', '8b283e8957f744ae5a1a6add05fc354f', 'admin', 1, '45178a4c1f8d9d62569d64157fd2f7ca'),
(2, 'gen_dir', '975fb5261439322d9739033f832417e2', 'gen_dir', 2, 'a7ec4e6835427fe47511203c6a7cbaa8'),
(3, 'otdel_rasch', '94e2a8c7f10afdd6e4f680214b34815a', 'otdel_rasch', 3, 'b9de6aa09a6bc2cb2ff95b5fbf9f3b24'),
(4, 'buhgal', '2be82ef3a4b472e6e205da0a597bad0f', 'buhgal', 4, '1235136d3d0c514456933d5aa340c01c'),
(5, 'isp_dir', '4baf868afc8a5386eb9a635b5a357237', 'isp_dir', 5, '198a65c22371db5c6ca02a8c346d2e77'),
(6, 'otdel_zakupok', '2c2e038e98530c7641d5ec286a4f4142', 'otdel_zakupok', 6, 'b2f312bdbf13f856ccc396149d8dae02'),
(7, 'konstr_tech', 'dc1e41ff2fb110e3ce3b1b81a227d79c', 'konstr_tech', 7, '4e4ea685111b3b34203061d4c900befb'),
(8, 'nach_sklada', 'd67dc98ce34c2c9081414a6288a26ebf', 'nach_sklada', 8, 'e770898213da072a9deaf17449e62bc4'),
(9, 'nach_proizv', 'be31f639c2a599e6b32fd635acc36798', 'nach_proizv', 9, 'fcac5065f656d289e1df9c595331df58');
...
--
ALTER TABLE `contracts`
  MODIFY `Contract_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `dir_of_works`
  MODIFY `Work_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `equipment`
  MODIFY `Equip_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT для таблицы `equip_for_proj`
--
ALTER TABLE `equip_for_proj`
  MODIFY `Eq_proj_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `konstr_doc`
--
ALTER TABLE `konstr_doc`
  MODIFY `Konstr_doc_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `mater_for_proj`
  MODIFY `Mat_proj_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `projects`
--
ALTER TABLE `projects`
  MODIFY `Proj_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT для таблицы `project_stages`
--
ALTER TABLE `project_stages`
  MODIFY `Stage_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT для таблицы `providers`
--
ALTER TABLE `providers`
  MODIFY `Prov_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT для таблицы `pr_contract_docs`
--
ALTER TABLE `pr_contract_docs`
  MODIFY `Pr_doc_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `specifications`
--
ALTER TABLE `specifications`
  MODIFY `Spec_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `supplies`
--
ALTER TABLE `supplies`
  MODIFY `Supp_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT для таблицы `techn_doc`
--
ALTER TABLE `techn_doc`
  MODIFY `Techn_doc_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT для таблицы `tech_doc`
--
ALTER TABLE `tech_doc`
  MODIFY `Tech_doc_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
