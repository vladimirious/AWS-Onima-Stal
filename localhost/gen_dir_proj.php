        ...
        <div class="main-w" style="width: 980px; height:661px;">
		  ...
		  <?if($stats[1]==0) echo '<form method="POST">';?>
			...
			<div class="row mt-4 ml-5 mr-3 align-items-center">
				...
				<select <?if($stats[1]==1) echo "disabled";?> class="col-md-3 text-left pr-3 form-control" name="status" id="status" style="height:35px; border: 1px solid #707070; background: rgba(0,0,0,0.2);font-size: small;">
			...
			<div class="row mt-1 ml-4 mr-3" style="padding-top:9rem;">
			<!--<div class="row mt-4 ml-5 mr-3 align-items-center">-->
				 <div class="col-md-2 p-0 ml-4" name="cust_id">
