			  ...
			  <div class="col-md-2 p-0 ml-4" >
                  <table class="table table-sm" >
                     <tbody>
						...
						<tr>
							<td class="" colspan="2"  style="background-color: rgba(0,0,0,0.1); border: 1px solid #707070; text-align:center;" ><small><a href="otdel_rasch_cont_prep?n=<?echo $_GET["n"];?>">Подробнее</a></small></td>
						</tr>
					 	<tr>
                     </tbody>
                   </table>
