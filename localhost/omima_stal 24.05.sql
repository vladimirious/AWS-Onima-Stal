...
(4, 4, '2019-05-17', '2019-05-18', 1, '2019-05-23', '2019-05-20', 0, NULL, '2019-05-21', 0, NULL, '2019-05-22', 0, NULL, NULL);
...
(1, 1, 1, 0, '100 литров', 'Молоко не более 3.5%', 'files\\purchase_docs\\purchase_n1.png', 0, 4, 1);
...
(1, 'admin1', '8b283e8957f744ae5a1a6add05fc354f', 'admin', 1, 'da47a6a02c14dec3e9c9b1f11ac68d96'),
(2, 'gen_dir', '975fb5261439322d9739033f832417e2', 'gen_dir', 2, '31ca8f0f372eb7bc628dcaa7b6bf16be'),
(3, 'otdel_rasch', '94e2a8c7f10afdd6e4f680214b34815a', 'otdel_rasch', 3, '24b148301490b43978e7defe67533859'),
(4, 'buhgal', '2be82ef3a4b472e6e205da0a597bad0f', 'buhgal', 4, '16722181a0ec8fa6ae50f7a82c45d852'),
(5, 'isp_dir', '4baf868afc8a5386eb9a635b5a357237', 'isp_dir', 5, 'f8be30709610ed45b8a2d2b217388366'),
(6, 'otdel_zakupok', '2c2e038e98530c7641d5ec286a4f4142', 'otdel_zakupok', 6, '9073ddb6a94330400002a0f445cd9e18'),
(7, 'konstr_tech', 'dc1e41ff2fb110e3ce3b1b81a227d79c', 'konstr_tech', 7, '9202222924dbc092ccd68ef3c67b4836'),
...
--
ALTER TABLE `dir_of_works`
  MODIFY `Work_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `providers`
  MODIFY `Prov_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `pr_contract_docs`
--
ALTER TABLE `pr_contract_docs`
  MODIFY `Pr_doc_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `supplies`
  MODIFY `Supp_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
