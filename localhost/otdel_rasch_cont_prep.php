...
if ($_SESSION['Interface']!='otdel_rasch')
{
	header("Location: login");
	exit;
}
				...
				<div class="side-bar" style="width: 100px; height:661px;">
					...
					<div class="row-fluid">
						<div class="col text-center nopadding">
							<a href="otdel_rasch_proj?n=<?echo $_GET['n']?>"><img src="img/back.png" class="img" title="К этапам проекта"></a>
						</div>
					</div>
					
					<div class="row-fluid">
						<div class="col text-center nopadding">
							<a href="otdel_rasch_projs"><img src="img/proj_sb_a.png" class="img" title="Проекты"></a>
						</div>
					</div>
					...
					<div class="row-fluid ml-3 ">	
						<div class="col-md-12 ">
							<ul class="nav nav-tabs fluent-tabs" id="myTab" role="tablist" >
								<li class="nav-item">
									<a class="nav-link active show" id="tech_docs-tab" role="tab" aria-selected="true" aria-controls="tech_docs" href="#tech_docs" data-toggle="tab"><small>Технические док.</small></a>
								</li>
							...
							<div class="tab-content" id="myTabContent" >
								<div class="tab-pane fade active show" id="tech_docs" role="tabpanel" aria-labelledby="tech_docs-tab">
...
?>
								...
								<div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="plan-tab">
									<div class="row-fluid mt-4 mr-3">
										<div class="col nopadding">
											<?if (!$plan)
												echo '<button class="btn btn-primary btn-sm ml-0" onClick=\'location.href="otdel_rasch_new_plan?n='.$_GET["n"].'"\'><small>Добавить</small></button>';
											else{									
												//
												//if($smeta[0]==1) $signed_up = $contract[1];
												if (!$plan[0])
													$approved="Нет";
											...
											<div class="row mt-4 mr-5 align-items-center" style="">
												...
												<div class="col-md-3">
													<button class="btn btn-secondary btn-sm btn-block m-0" onclick=\'location.href="otdel_rasch_edit_plan?n='.$_GET["n"].'&doc='.$plan[3].'"\'><small>Изменить</small></button>
												</div>
											</div>';
											}?>
										</div>
								...
								<div class="tab-pane fade" id="smeta" role="tabpanel" aria-labelledby="smeta-tab">
									<div class="row-fluid mt-4 mr-3">
										<div class="col nopadding">
											<?if (!$smeta)
												echo '<button class="btn btn-primary btn-sm ml-0" onClick=\'location.href="otdel_rasch_new_smeta?n='.$_GET["n"].'"\'><small>Добавить</small></button>';
											else{									
												//
												//if($smeta[0]==1) $signed_up = $contract[1];
												if (!$smeta[0])
											...
											<div class="row mt-4 mr-5 align-items-center" style="">
												<div class="col-md-3 text-right" style=""></div>
												<div class="col-md-3">
													<button class="btn btn-secondary btn-sm btn-block m-0" onclick=\'location.href="otdel_rasch_edit_smeta?n='.$_GET["n"].'&doc='.$smeta[3].'"\'><small>Изменить</small></button>
												</div>
											</div>';
											}?>
										</div>
