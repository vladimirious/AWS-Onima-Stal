...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		if(($_POST['work_id']=="no")&&($_POST['new_type_of_work']!="")){
			...
			header("Location: konstr_tech_new_purchase?n=".$_GET["n"]);
			//exit;
...
?>			
												...
												<div class="row align-items-center ml-2" style="padding-top: 3rem;">
													<div class="col pl-0 pr-0"  >
														<button class="btn btn-primary btn-sm ml-0" type="submit" name="submit">Добавить</button>
													</div>
												</div>
											</form>
										</div>
