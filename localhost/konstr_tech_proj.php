...
{
	$QUERY ="UPDATE project_stages SET Stat_2 = 1 WHERE Proj_id =".$_GET["n"];
        ...
        <div class="main-w" style="width: 980px; height:661px;">
          ...
          <div class="row-fluid ml-3">
			  ...
			  <div class="col-md-2 p-0 ml-4" >
                  <table class="table table-sm" >
                     <tbody>
						...
						<tr>
							<td class="" colspan="2"  style="background-color: rgba(0,0,0,0.1); border: 1px solid #707070; text-align:center;" ><small><a href="konstr_tech_cont_prep?n=<?echo $_GET["n"];?>">Подробнее</a></small></td>	
						</tr>
                     </tbody>
                   </table>
              </div>
			  ...
			  <div class="col-md-2 p-0 ml-4" >
                  <table class="table table-sm" >
                     <tbody>
						...
						<tr>
							<td class="" colspan="2"  style="background-color: rgba(0,0,0,0.1); border: 1px solid #707070; text-align:center;" ><small><a href="konstr_tech_ktp?n=<?echo $_GET["n"];?>">Подробнее</a></small></td>
						</tr>
                     </tbody>
                   </table>
              </div>
			...
			<?if ($stages_stats[1]==0) echo '
				...
				else if(($stages_stats[1]==1)&&($dates[4]=="")) echo '
