...
<head>
  ...
  <title>Меню начальника склада</title>
    <!-- Bootstrap core CSS -->
    ...
    <div class="main-w" style="width: 1080px; height:661px;">
      <div class="container-fluid">
        ...
        <div class="row ml-5 pt-4 pb-4">
          <div class="col-md-1">
              <a href="nach_sklada_projs"><img src="img/proj.png" class="img"></a>
          </div>
          <div class="col">
              <a href="nach_sklada_projs" style="text-decoration: none;"><div class="sh1" style="color: #FFFFFF; font-weight: italic;">Проекты</div></a>
          </div>
        </div>
		
		<div class="row ml-5 pb-4 pt-4">
          <div class="col-md-1">
              <a href="nach_sklada_equip"><img src="img/equip.png" class="img"></a>
          </div>
          <div class="col">
              <a href="nach_sklada_equip" style="text-decoration: none;"><div class="sh1" style="color: #FFFFFF;">Оборудование</div></a>
          </div>
        </div>
