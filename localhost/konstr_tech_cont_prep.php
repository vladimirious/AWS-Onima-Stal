								...
								<div class="tab-pane fade active show" id="contract" role="tabpanel" aria-labelledby="contract-tab" >
									<div class="row-fluid mt-4 mr-3">
										<div class="col nopadding">
											<?if (!$contract){
												echo '<div style="color: black; opacity: 0.3">Договор не найден</div>';
											}
											else{
										...
										<div class="col nopadding">
											...
											<div class="row mt-3 mr-5 align-items-center" style="">
												...
												<div class="col-md-2">
													...
													echo 'class="btn btn-success btn-sm btn-block m-0 pl-0 pr-0 pr-0" type="submit" name="plan_approved">Согласовать</button></form>
												</div>
