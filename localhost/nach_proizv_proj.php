...
{
	$QUERY ="UPDATE project_stages SET Stat_3 = 1 WHERE Proj_id =".$_GET["n"];
    ...
    <div class="row justify-content-md-center" style="width:1080px;">
      <div class="col-fluid" >
        <div class="side-bar" style="width: 100px; height:661px;">
			...
			<div class="row-fluid">
				<div class="col text-center nopadding">
					<a href="nach_proizv_projs"><img src="img/proj_sb_a.png" class="img"></a>
				</div>
			</div>
        </div>
      </div>
	  ...
	  <form method="POST">
        <div class="main-w" style="width: 980px; height:661px;">
          ...
          <div class="row-fluid ml-3">
			  ...
			  <div class="col-md-2 p-0 ml-4" >
                  <table class="table table-sm" >
                     <tbody>
						...
						<tr>
							<td class="" colspan="2"  style="background-color: rgba(0,0,0,0.1); border: 1px solid #707070; text-align:center;" ><small><a href="nach_proizv_cont_prep?n=<?echo $_GET["n"];?>">Подробнее</a></small></td>
						</tr>						
                     </tbody>
                   </table>
              </div>
			  ...
			  <div class="col-md-2 p-0 ml-4" >
                  <table class="table table-sm" >
                     <tbody>
						...
						<tr>
							<td class="" colspan="2"  style="background-color: rgba(0,0,0,0.1); border: 1px solid #707070; text-align:center;" ><small><a href="nach_proizv_ktp?n=<?echo $_GET["n"];?>">Подробнее</a></small></td>
						</tr>
                     </tbody>
                   </table>
              </div>
			  ...
			  <div class="col-md-2 p-0 ml-4" >
                  <table class="table table-sm" >
                     <tbody>
						...
						<tr>
							<td class="" colspan="2"  style="background-color: rgba(0,0,0,0.1); border: 1px solid #707070; text-align:center;" ><small><a href="nach_proizv_pr?n=<?echo $_GET["n"];?>">Подробнее</a></small></td>
						</tr>
                     </tbody>
                   </table>
              </div>
			...
			<?if ($stages_stats[2]==0) echo '
					<button class="btn btn-danger btn-sm btn-block m-0" type="submit" name="submit" title="Нажмите, чтобы отправить на согласование завершение этапа производства."><small>завершить этап</small></button>';
				else if(($stages_stats[2]==1)&&($dates[6]=="")) echo '
					<div class="text-center" style="background-color: #c3562f; color: #ddd8d5; font-size: 15px; padding-top: 4px; padding-right: 10px; padding-bottom: 4px; padding-left: 10px; border: 2px solid #c6535b; cursor:default"  title="Ожидается согласование завершения этапа производства."><small>ЗАВЕРШАЕТСЯ..</small></div>';
				else echo "";
				#dc3545
			?>
				</div>
