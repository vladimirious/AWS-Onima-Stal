    ...
    <div class="row justify-content-md-center" style="width:1080px;">
      <div class="col-fluid" >
        <div class="side-bar" style="width: 100px; height:661px;">
		  ...
		  <div class="row-fluid">
            <div class="col text-center nopadding">
            <img src="img/equip_sb_a.png" class="img">
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col">
              <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar pr-3">
                  <table class="table table-hover table-striped table-sm" style="overflow: auto">
                    <thead>
                       <tr>
                         <th scope="col" style="vertical-align: top;"><small>Наименование</small></th>
                         <th scope="col" style="vertical-align: top;"><small>Серийный номер</small></th>
                         <th scope="col" style="vertical-align: top;"><small>Местонахождение</small></th>
                         <th scope="col" style="vertical-align: top;"><small>Стоимость, руб.</small></th>
						 <th scope="col" style="vertical-align: top;"><small>Срок эксплуатации</small></th>
						 <th scope="col" style="vertical-align: top;"><small>Дата введения в эксп.</small></th>
						 <th scope="col" style="vertical-align: top;"><small>Ред.</th>
                       </tr>
                     </thead>
                     <tbody>
<?php
...
//	echo $rows;
		for ($i = 0 ; $i < $rows ; ++$i)
		{
			...
			$row = mysqli_fetch_row($result);
				for ($j = 0 ; $j < 5 ; ++$j) echo "<td><small>".$row[$j]."</small></td>";
			echo "<td><small>".date("d.m.Y",strtotime($row[5]))."</small></td>";
			echo "<td class='text-center'><a href='nach_sklada_edit_equip?n=".$row[6]."' title='Нажмите, чтобы перейти к редактированию оборудования.'><small>Ред.</small></a></td>";
			echo "</tr>";
		}
...
?>
				...
				<button class="col-md-2 btn btn-primary btn-block btn-sm ml-0" onClick='location.href="nach_sklada_new_equip"'><small>Добавить</small></button>
              </div>
            </div>
        </div>
      </div>
