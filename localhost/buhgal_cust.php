    ...
    <div class="row justify-content-md-center" style="width:1080px;">
      <div class="col-fluid" >
        <div class="side-bar" style="width: 100px; height:661px;">
          ...
          <div class="row-fluid">
            <div class="col text-center nopadding">
				<a href="buhgal_projs"><img src="img/proj_sb.png" class="img" title="Проекты"></a>
            </div>
          </div>
			<div class="row-fluid">
				<div class="col text-center nopadding">
              ...
              <p class="sh1">Информация о заказчике</p>
					...
					<div class="row mt-2 mr-5 align-items-center" style="">
						...
						<div class="col pl-0">
							...
							<button class="row btn btn-secondary btn-sm ml-1" id="change_button"><small>Изменить</small></button>
						</div>
