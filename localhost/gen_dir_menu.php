...
<head>
  ...
  <title>Меню генерального директора</title>
    <!-- Bootstrap core CSS -->
    ...
    <div class="main-w" style="width: 1080px; height:661px;">
      <div class="container-fluid">
        ...
        <div class="row ml-5 pt-4 pb-4">
          <div class="col-md-1">
              <a href="gen_dir_projs"><img src="img/proj.png" class="img"></a>
          </div>
          <div class="col">
              <a href="gen_dir_projs" style="text-decoration: none;"><div class="sh1" style="color: #FFFFFF; font-weight: italic;">Проекты</div></a>
          </div>
        </div>
		
		
        <a href="admin_users_edit"><div class="row ml-5 pb-4 pt-4"></a>
          <div class="col-md-1">
              <a href="gen_dir_effect"><img src="img/effect.png" class="img"></a>
          </div>
          <div class="col">
              <a href="gen_dir_effect" style="text-decoration: none;"><div class="sh1" style="color: #FFFFFF;">Эффективность</div></a>
          </div>
        </div>
		 ...
		 <a href="admin_users_edit"><div class="row ml-5 pb-4 pt-4"></a>
          <div class="col-md-1">
              <a href="gen_dir_stat"><img src="img/stat.png" class="img"></a>
          </div>
          <div class="col">
              <a href="gen_dir_stat" style="text-decoration: none;"><div class="sh1" style="color: #FFFFFF;">Статистика</div></a>
          </div>
        </div>
		...
		<a href="admin_users_edit"><div class="row ml-5 pb-4 pt-4"></a>
          <div class="col-md-1">
              <a href="gen_dir_equip"><img src="img/equip.png" class="img"></a>
          </div>
          <div class="col">
              <a href="gen_dir_equip" style="text-decoration: none;"><div class="sh1" style="color: #FFFFFF;">Оборудование</div></a>
          </div>
        </div>
