					...
					<div class="row-fluid ml-3 ">	
						<div class="col-md-12 ">
							<ul class="nav nav-tabs fluent-tabs" id="myTab" role="tablist" >
								...
								<li class="nav-item">
									<a class='nav-link ' id='smeta-tab' role='tab' aria-selected='false' aria-controls='plan' href='#smeta' data-toggle='tab'><small>Смета</small></a>
								</li>									
							</ul>
										...
										<div class="col nopadding">
											...
											<div class="row mt-4 mr-5 align-items-center" style="">
												...
												<div class="col-md-2 " name="cust_id">
													<button class="btn btn-secondary btn-sm btn-block m-0" onClick=\'location.href="buhgal_edit_contract?n='.$_GET["n"].'"\'><small>Изменить</small></button>
												</div>
											</div>';
											}?>
